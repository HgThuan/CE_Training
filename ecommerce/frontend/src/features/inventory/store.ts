...
export const useInventoryStore = defineStore('inventory', () => {
  ...
  async function saveStockEntry(payload: StockEntryPayload, entryId?: number): Promise<StockEntry> {
  ...
  async function updateThreshold(variantId: string, lowStockThreshold: number): Promise<void> {
