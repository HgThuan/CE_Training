...
class InventoryListView(generics.GenericAPIView):
    ...
    def get(self, request):
        ...
        return self.get_paginated_response(InventoryBalanceSerializer(page, many=True).data)
...
class StockOutEntryListCreateView(generics.GenericAPIView):
    ...
    def get(self, request):
        ...
        return self.get_paginated_response(StockOutEntrySerializer(page, many=True).data)
